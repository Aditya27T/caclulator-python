...
class Calculator:
    def __init__(self):
        ...
        self.window.configure(bg='#090900')
        self.window.bg = '#090900'
    ...
    def bind_backspace(self):
        self.window.bind("<BackSpace>", lambda event: self.deleteOne())
    ...
    def create_delete_button(self):
        button = tk.Button(self.buttons_frame, text="Del", bg=OFF_WHITE, fg=LABEL_COLOR, font=DEFAULT_FONT_STYLE,
                           borderwidth=1, command= lambda: self.deleteOne())
    ...
    def create_clear_button(self):
        ...
        button.grid(row=0, column=0, sticky=tk.NSEW, rowspan=10)
